...
```sh
git clone https://github.com/16-vikrant/wannierberri.git
cd wannierberri
...
| Name | E-mail     |
|------|------------|
| Vikrant Chaudhary | [vikrant.chaudhary@physik.hu-berlin.de](mailto:vikrant.chaudhary@physik.hu-berlin.de)
